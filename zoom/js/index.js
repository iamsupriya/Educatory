...
function websdkready() {
  ...
  ZoomMtg.preLoadWasm();
  ZoomMtg.prepareJssdk(); // pre download wasm file to save time.

  var API_KEY = "gOz5D3QBT36PjFeC66NqTg";
   ...
   */
  var API_SECRET = "wOT63lM3kUqVf6h4Tpz8O97z3VEGJaVirofp";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/Users/Supriya/Downloads/educatory/zoom//meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "/Users/Supriya/Downloads/educatory/zoom/meeting.html?" +
